 ...
 * Byblio
 * Search engine
 * Creates return info for testing CMS delte content from content search nidex
...
class ContentDeleteFromIndex{
	...
	public function getDeleteInfoHTML($translate, $inputList){
